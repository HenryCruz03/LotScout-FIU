...
const buildings = [
  ...
  { "acronym": "WPAC", "full_name": "Herbert and Nicole Wertheim Performing Arts Center" },
  ...
  { "acronym": "MANGO", "full_name": "Management and New Growth Opportunities Building" },
  ...
  { "acronym": "SIPA", "full_name": "Steven J. Green School of International and Public Affairs" },
...
export default function HomeScreen({ navigation }) {
  ...
  const searchBuilding = () => {
    ...
    // Partial match (full name contains query)
      ...
      let partialMatches = buildings.filter(
        b => b.full_name.toLowerCase().includes(q)
      );
